...
function enviarCancionYFrase(chatId) {
  ...
  bot.sendMessage(chatId, `¡Buenos días! Empieza el día con Ánimos y buena letra. Disfruta esta canción: ${cancion}`).then(() => {
...
cron.schedule('55 15 * * *', () => {
  ...
  bot.sendMessage(chatId, frase + "\n  Has salido del trabajo gordii? Descansa. Si no has salido, animate!! Que cuanto más trabajes, más 💸💸");
...
cron.schedule('11 21 * * *', async () => {
  ...
  bot.sendMessage(chatId, `Don't go to sleep without learning something new. \n🧠 Curiosity of the Day:\n${curiosidad}`);
